...
This is a tool that provides extra Intseger or only number methods. It allows to perform some actions more easily with `Intsegers or only numbers` types which makes it simpler, more flexible, more practical and less effort.
